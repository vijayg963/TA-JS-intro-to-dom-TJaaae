...
allHrsArray.forEach((elm) => (elm.style.border = `5px solid tomato`));
...
let hrClassImg = document.querySelectorAll(`.image`);
hrClassImg.forEach((elm) => (elm.style.border = `2px solid purple`));
...
let box55 = document.querySelector(".five");
